#!/usr/bin/env node
/**
 * Script puntual de prueba — insertar paciente en producción y enviar correo.
 * Uso: node --env-file=.env.local scripts/_test-send-laura.js
 * Eliminar después de confirmar el test.
 */
...
const PACIENTE = {
  ...
  nombre_paciente:     'Laura Vanessa Osorio Alvarez',
  numero_asegurado:    '1020462187',
  correo:              'laubay58@gmail.com',
  telefono:            null,
  ...
  hora_cita:           '09:30',
  ultimos_4_asegurado: '2187',
  estado:              'PENDIENTE',
  campana_id:          'CAMP-TEST-2026-06-18',
...
async function main() {
  ...
  // ── 3. Enviar correo vía SendGrid (una sola llamada) ───────────────────────
  const payload = {
    personalizations: [{
