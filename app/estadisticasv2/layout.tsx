...
import ViewerLogoutButton from '../estadisticas/ViewerLogoutButton'

export const metadata = {
  title: 'Resultados CLEO v2 — CCSS UTLE',
  robots: 'noindex, nofollow',
}

export default function EstadisticasV2Layout({ children }: { children: React.ReactNode }) {
  return (
